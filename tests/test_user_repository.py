...
class TestUserRepositoryPasswordHashing:
    ...
    async def test_verify_user_password_correct(self, user_repository):
        ...
        result = await user_repository.verify_user_password("test@example.com", test_password)
        user_repository.collection.find_one.assert_called_with({"email": "test@example.com"})
        assert result is True
        
        # Test with wrong password
        result = await user_repository.verify_user_password("test@example.com", "wrongpassword")
    ...
    async def test_verify_user_password_user_not_found(self, user_repository):
        ...
        result = await user_repository.verify_user_password("nonexistent@example.com", "anypassword")
        assert result is False
    ...
    async def test_verify_user_password_no_hash_field(self, user_repository):
        ...
        result = await user_repository.verify_user_password("test@example.com", "anypassword")
        assert result is False 